...
- **Offline fallback** — 15 built-in quotes if there's no internet
- **4 categories** — Success, Mindset, Health, Leadership (toggle any combination)
...
```bash
git clone https://github.com/YOUR_USERNAME/motivationalSaver.git
